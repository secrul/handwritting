...
def handwritingClassTest():
    hwLabels = []
    trainingFileList = listdir(r'data/trainingDigits') ## 获取训练目录的内容
    ...
    ## 解析测试数据文件
    testFileList = listdir(r'data/testDigits')
    ...
    print ("预测错误率: %f " % (errorCount/float(mTest)))
    print ("预测正确率: %2.2f%%" % ((1-errorCount/float(mTest))*100))
